package org.signallite.integrations.robotlegs
{
    ...
    {
        function map(type:MessageType, commandClass:Class, oneShot:Boolean = false):void;
        function hasCommand(type:MessageType, commandClass:Class):Boolean;
        function unmap(type:MessageType, commandClass:Class):void;
